...
```
git clone https://github.com/BilalLiaquat7/Leaderboard.git
```
...
Feel free to leave any suggestions at the [Issues page](https://github.com/BilalLiaquat7/Leaderboard/issues)
